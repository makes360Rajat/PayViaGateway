    ...
    <div className="w-68 shrink-0 border-r border-white/10 bg-[#0b0b12] backdrop-blur-2xl h-full p-4 flex flex-col justify-between shadow-2xl overflow-y-auto">
      <div className="space-y-6">
        ...
        <div className="md:hidden px-2 pb-3 border-b border-white/10 flex items-center justify-between">
          <img src={payviaLogo} alt="PayVia360 Logo" className="h-9 w-auto object-contain drop-shadow-[0_0_15px_rgba(16,185,129,0.25)]" />
          {onClose && (
            <button
              onClick={onClose}
      ...
      <div className="space-y-3 pt-4">
        ...
        <div className="rounded-2xl border border-purple-500/30 bg-[#13131f]/90 p-4 shadow-glow relative overflow-hidden">
        ...
        {/* Workspace Nav & Version in Bottom */}
